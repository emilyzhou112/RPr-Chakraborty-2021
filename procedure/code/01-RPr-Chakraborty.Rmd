...
packages = c("tidycensus", "tidyverse", "downloader", "haven", "stars", "dplyr", "sf", "rdhs", "classInt", "readr", "ggplot2", "here", "s2", "pastecs", "tmap", "SpatialEpi", "svDialogs", "geepack")
...
```{r}
original_cluster_1 <- read_sf(here("data", "derived", "public","satscan", "sat_scan_compare.gis.shp"))
original_cluster_2 <- read_sf(here("data", "derived", "public","satscan", "sat_scan_compare.col.shp"))
...
cluster_table <- st_drop_geometry(original_cluster_2)
